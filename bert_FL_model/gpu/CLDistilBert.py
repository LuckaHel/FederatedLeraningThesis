...
for epoch in range(5):
    ...
    print(f"✅ Val — Acc: {acc:.4f} | Precision: {precision:.4f} | Recall: {recall:.4f} | F1: {f1:.4f}")
...
model.save_pretrained("finetuned_distilbert_uncased")
tokenizer.save_pretrained("finetuned_distilbert_uncased")
